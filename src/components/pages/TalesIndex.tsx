import { estimateReadTime, getTales, matchesPerspectiveView, type PerspectiveView } from '@/lib/content';
import { TalesGridClient, type TalesGridItem } from '@/components/pages/TalesGridClient';

export function TalesIndex({
  lang,
  basePath,
  view,
  embedded = false,
  ...
  const items: TalesGridItem[] = posts.map((post, idx) => {
    ...
    <div className="max-w-6xl mx-auto px-6 py-16">
      <header className="mb-12">
        <div className="flex items-center gap-4 mb-6">
          <h1 className="text-3xl font-light text-frc-gold tracking-tight">Tales</h1>
